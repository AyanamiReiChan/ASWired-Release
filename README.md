...
ASWired **v1.0.6** 部署仓库，包含网站、Go 主控、管理 Agent，以及我们修改的 **Komari 1.2.5-fix2-aswired.1.0.6**。这里保存部署脚本、配置和文档；编译好的程序在 [Releases](https://github.com/AyanamiReiChan/ASWired-Release/releases) 下载，无需在服务器安装 Go、npm 或编译源码。
...
主控健康检查应返回 `status=ok`、`version=v1.0.6`；Komari 版本应为 `1.2.5-fix2-aswired.1.0.6`。安装器不会修改系统防火墙、覆盖已有数据或生成管理员账户。
